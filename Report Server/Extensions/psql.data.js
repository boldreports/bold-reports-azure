var PSQLDataSource = (function () {
    ...
    PSQLDataSource.prototype.renderPsqlPanel = function () {
        ...
        this.renderCheckboxItem(this.getLocale('savePassword'), this.id + '_psql_save_password', psqlConfigTable, null, this, 'right');
        ...
        this.savePasswrdTag = this.psqlPanel.find('#' + this.id + '_psql_save_password_tr');
        this.ejPsqlSavePasswrd = this.psqlPanel.find('#' + this.id + '_psql_save_password').data('ejCheckBox');
    };
    ...
    PSQLDataSource.prototype.updateDataSource = function (dataSource) {
        if (!ej.isNullOrUndefined(dataSource)) {
            ...
            this.ejPsqlSavePasswrd.option('checked', dataSource.ConnectionProperties.EmbedCredentials);
            if (!dataSource.ConnectionProperties.IntegratedSecurity &&
                ...
                this.ejAuthDrpdwn.setModel({ 'text': this.getLocale('authentication') });
                this.ejPsqlSavePasswrd.option('checked', false);
            }
            else if (!dataSource.ConnectionProperties.IntegratedSecurity) {
    ...
    PSQLDataSource.prototype.resetInputFields = function () {
        ...
        this.ejPsqlSavePasswrd.setModel({ 'checked': false });
    };
    PSQLDataSource.prototype.getDatasourceInfo = function (dataSourceName, dataSource) {
        ...
        if (isValidCon) {
            ...
            if (this.ejAuthDrpdwn.getSelectedValue() === 'authentication' && this.ejPsqlSavePasswrd.model.checked) {
            ...
            else if (this.ejAuthDrpdwn.getSelectedValue() === 'authentication' && !this.ejPsqlSavePasswrd.model.checked) {
                reportData.ConnectionProperties.UserName = usrName;
                reportData.ConnectionProperties.PassWord = password;
            }
            return reportData;
    ...
    PSQLDataSource.prototype.getLocale = function (text) {
        ...
        switch (text.toLowerCase()) {
            ...
            case 'savepassword':
                if (pSQLLocale && pSQLLocale.savePassword) {
                    return pSQLLocale.savePassword;
                }
    ...
    PSQLDataSource.prototype.updateCulture = function (culture) {
        this.locale = culture;
        var savePassword = this.psqlConfig.find('#' + this.id + '_psql_save_password');
        if (this.connString) {
        ...
        if (savePassword) {
            this.updateRow(this.psqlConfig, savePassword.attr('id'), this.getLocale('savepassword'));
        }
    };
    ...
    PSQLDataSource.prototype.renderCheckboxItem = function (name, id, target, fnction, context, align) {
