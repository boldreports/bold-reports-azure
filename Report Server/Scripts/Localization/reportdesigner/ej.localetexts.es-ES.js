ej.ReportDesigner.Locale['es-ES'] = {
    ...
    codeDialog: {
        ...
        code: {
            ...
            tooltip: 'El motor de informes Syncfusion admite funciones de código VB para integrarse con elementos y datos del informe.',
    ...
    mapCustomColors: {
        headerText: 'Mapa de colores personalizados',
        updateText: 'Actualizar',
        add: 'AÑADIR',
        label: 'Color',
        deletefield: 'Eliminar',
