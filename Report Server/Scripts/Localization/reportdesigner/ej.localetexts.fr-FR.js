ej.ReportDesigner.Locale['fr-FR'] = {
    ...
    codeDialog: {
        ...
        code: {
            ...
            tooltip: 'Le moteur de génération de rapports Syncfusion prend en charge les fonctions de code VB à intégrer aux éléments de rapport et aux données.',
    ...
    mapCustomColors: {
        headerText: 'Couleurs personnalisées de la carte',
        updateText: 'Mise à jour',
        add: 'AJOUTER',
        label: 'Couleur',
        deletefield: 'Supprimer',
