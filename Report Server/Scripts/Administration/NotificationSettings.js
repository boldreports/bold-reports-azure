...
$(document).on("click", "#update-notification-settings", function () {
    var notificationSettingsPost = {
        ...
        EnableReportScheduleNotification: $("#enable-report-notification").is(":checked"),
        EnableUserScheduleNotification: $("#enable-synchronize-notification").is(":checked")
    };
    ...
    var notificationAdministrationPost = {
        ...
        EnableReportScheduleNotification: $("#restrict-report-notification").is(":checked"),
        EnableUserScheduleNotification: $("#restrict-synchronize-notification").is(":checked")
    };
