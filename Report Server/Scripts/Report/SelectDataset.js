$(function () {
    ...
    $(document).on("change", "#browse_file", function () {
        ...
        if (filename.substring(filename.lastIndexOf('.') + 1) == "rsd") {
            ...
            $("#validate-file").text(window.Server.App.LocalizationContent.RSDUpload);
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.Data) {
                    ...
                    $("#validate-name").text(window.Server.App.LocalizationContent.DatasetNameAlreadyExist);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.result.Status) {
                    ...
                    closeNewDatasetPopup();
                    parent.messageBox("su-dataset", window.Server.App.LocalizationContent.AddDatasetButton, window.Server.App.LocalizationContent.FailedMessageDataset, "success");
                }
            },
        });
    }
...
function onAvailableDatasetTabSelect() {
    ...
    $("#publish_dataset").attr("value", window.Server.App.LocalizationContent.SelectButton);
}
...
function onNewDatasetTabSelect() {
    ...
    $("#publish_dataset").attr("value", window.Server.App.LocalizationContent.AddButtonDatasource);
}
