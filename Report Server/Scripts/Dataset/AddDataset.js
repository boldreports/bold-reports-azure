        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.result.Status) {
                    closeNewDatasetAddPopup();
                    parent.messageBox("su-dataset", window.Server.App.LocalizationContent.AddDatasetButton, window.Server.App.LocalizationContent.AddDatasetSuccess, "success", function () {
                    ...
                    closeNewDatasetAddPopup();
                    parent.messageBox("su-report", window.Server.App.LocalizationContent.AddDatasetButton, window.Server.App.LocalizationContent.FailedMessageDataset, "success");
                }
            },
            error: function (e) {
                window.parent.$("#addDataSetDom_wrapper").ejWaitingPopup("hide");
