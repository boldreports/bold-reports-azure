...
$(function () {
    ...
    autoCompleteControlEle.ejAutocomplete({
        ...
        watermarkText: "John Doe, Sales Team",
        width: "100%",
        multiSelectMode: ej.MultiSelectMode.VisualMode,
        showPopupButton: false,
        showEmptyResultText: true,
        emptyResultText: window.Server.App.LocalizationContent.NoUserorGroup,
...
function getUserGroupProfilePicture(Name, Value, Type, IdPReferenceId) {
    ...
    return "<div class='col-xs-2 no-padding search-user-group-img-container'><div class='group-logo'><i class='su su-" + Type + "'><i class='su su-" + Type + " path1'></i></i></div></div><div class='col-xs-9 no-padding search-user-group-display-name-container'><div class='search-user-group-display-name'><span>" + Name + "</span></div></div>";
}
