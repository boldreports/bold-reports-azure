...
$(document).ready(function () {
    ...
    var unlockFeatureDialogobj = new ejs.popups.Dialog({
        ...
        closeOnEscape: false,
        visible: false,
        width: isSelfHosted ? '400px' : '802px',
        height: '420px',
    ...
    if (haveCustomDomainAccess.toLocaleLowerCase() === "false" && haveWhiteLabelAccess.toLocaleLowerCase() === "false" && haveThirdPartyLogins.toLocaleLowerCase() === "false" || !isEmbedReport) {
