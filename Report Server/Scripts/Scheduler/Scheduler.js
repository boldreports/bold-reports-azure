...
$(document).on("change", "#selected_category", function () {
    ...
    $.ajax({
        type: "POST",
        url: getReportUrl,
        data: { searchKey: invalid, skip: null, take: null, sorted: invalid, filterCollection: filterSettings, displayCategory: "SpecificCategory", getAllItems: true },
    ...
    if (!$(".schedule-dialog").hasClass(className)) {
        ...
        parent.$("#editpopup-container_wrapper").ejWaitingPopup("show");
            ...
            success: function (data) {
                ...
                cursorPos = renderSimpleMde("#rte-post");
