    ...
    switch ($("#recurrence-type").val().toString().toLowerCase()) {
        ...
        case "monthly":
            if ($("#monthly").prop("checked")) {
                ...
                addScheduleDetail = window.Server.App.LocalizationContent.The + scheduleItem.WeekOfMonth.toString() + " " + $("#monthly-dow-day").find('option:selected').val() + window.Server.App.LocalizationContent.Every + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Month;
            }
            break;
        case "yearly":
            ...
            if ($("#yearly").prop("checked")) {
                ...
                if (scheduleItem.RecurrenceInterval == 1)
                    addScheduleDetail = window.Server.App.LocalizationContent.The + scheduleItem.WeekOfMonth.toString() + " " + $("#yearly-dow-day option:selected").val() + window.Server.App.LocalizationContent.Of + scheduleItem.MonthOfYear.toString();
                else
                    addScheduleDetail = window.Server.App.LocalizationContent.EveryMessage + scheduleItem.RecurrenceInterval.toString() + window.Server.App.LocalizationContent.Year + scheduleItem.WeekOfMonth.toString() + " " + $("#yearly-dow-day option:selected").val() + window.Server.App.LocalizationContent.Of + scheduleItem.MonthOfYear.toString();
            }
            break;
        case "hourly":
