...
$(document).ready(function () {
    ...
    for (i = 0; i < window.samplesList.length; i++) {
        totalNumberOfDashboards += window.samplesList[i].Reports.length;
    }
...
$(document).on("click", ".sample-item-popup-close, #close-button", function (e) {
    ...
    if ((window.parent.location.href.indexOf("/reports") > 0) && (parseInt(parent.dashboardItemCount) === 0) && isSampleDashboardAdded) {
