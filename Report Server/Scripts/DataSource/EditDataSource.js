                ...
                if (data.result.IsNameExist) {
                    ...
                    if (data.result.ConnectionStringStatus) {
                        if (data.result.Status) {
                            parent.messageBox("su-datasource", window.Server.App.LocalizationContent.UpdateDataSource, window.Server.App.LocalizationContent.DatasourceUpdateSuccess, "success", function () {
                            ...
                            SuccessAlert(window.Server.App.LocalizationContent.DatasourceUpdate, window.Server.App.LocalizationContent.DatasourceUpdateSuccess, 7000);
                        }
                        else {
                            $("#connection_test_validation_error").html(window.Server.App.LocalizationContent.DatasourceUpdateError);
                            parent.messageBox("su-datasource", window.Server.App.LocalizationContent.UpdateDataSource, window.Server.App.LocalizationContent.DatasourceUpdateFailed, "success");
                        }
                    }
                    else {
