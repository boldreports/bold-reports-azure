...
INSERT {database_name}.BOLDTC_AuthSettings (AuthProviderId, IsEnabled, CreatedDate, ModifiedDate, IsDefaultAuthentication, IsActive) VALUES (5, 1, UTC_TIMESTAMP(), UTC_TIMESTAMP(), 0, 1);
